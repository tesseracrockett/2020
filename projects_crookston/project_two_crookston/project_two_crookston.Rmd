...
##Here I am creating the linear model in order to do an anova. This is also seen in my answer to 3).
...
```
## in the terminal pane: (I really don't know what is going on here)

rstudio-user@application-2678342-deployment-6956598:/cloud git log$
