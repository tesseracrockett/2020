...
write_csv(surveys_complete, path = "/cloud/project//cloud/project/data_output/surveys_complete.csv")
```

```{r, purl=FALSE, eval=TRUE, echo=FALSE}
if (!dir.exists("/cloud/project/data_output")) dir.create("/cloud/project/data_output")
write_csv(surveys_complete, path = "/cloud/project/data_output/surveys_complete.csv")
```
