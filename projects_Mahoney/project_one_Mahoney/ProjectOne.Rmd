...
tibble [789 × 9] (S3: spec_tbl_df/tbl_df/tbl/data.frame)
 ...
 - attr(*, "spec")=
  ...
  ..   Notes = col_character()
  .. )
For R purposes I think that reference_no should be changed to character strings. These are labels and not a measurement, thus should be changed. This protects them from being accidentally changed somehow.
```
...
First I would plan on separating these into two named variables, younger_interval and older_interval. 
```
